...
FROM
(
    SELECT T3.user_id as user_id , sessionnum(T3.timestr,T3.user_id) as session_num ,sourceevent(T3.timestr,T3.user_id,T3.event_id) as source_event_id,T3.event_id as destination_event_id
    FROM
    (
